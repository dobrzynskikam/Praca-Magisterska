...
Istnieje kilka strategii slużących do redukcji problemu klasyfikacji dla wielu kategorii. Do najpopularniejszej metody należy redukcja takiego problemu do wielu przypadków dla dwóch klas. Metoda ma dwa warianty: jeden kontra res
