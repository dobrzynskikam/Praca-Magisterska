...
namespace MasterThesisApplication
{
    public class ViewModelLocator
    {
        ...
        public GestureDatabaseViewModel GestureDatabaseViewModel { get; } = new GestureDatabaseViewModel();
        public AddGestureViewModel AddGestureViewModel { get; } = new AddGestureViewModel();
    }
}
